...
#include <memory>
#include "../../concerntrationClock/add.h"
...
QT_MOC_LITERAL(1, 4, 6), // "getStr"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(4, 34, 21) // "on_buttonBox_rejected"

    },
    "Add\0getStr\0\0on_buttonBox_accepted\0"
...
void Add::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Add::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Add::getStr)) {
                *result = 0;
                return;
            }
        }
